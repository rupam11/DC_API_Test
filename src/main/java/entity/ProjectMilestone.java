...
public class ProjectMilestone implements Serializable {
	...
	@NotNull
	private List<ProjectActivity> projectMilestoneActivities = new ArrayList<ProjectActivity>();//Compliant/Non Compliant, Deviated etc
	 ...
	 * @param projectMilestoneActivities
	 */
	public ProjectMilestone(@NotNull int projectMilestoneId, @NotNull int projectMilestoneCompletion,
			...
			@NotNull String projectMilestoneCostCompliance, @NotNull List<ProjectActivity> projectMilestoneActivities) {
		super();
		...
		this.projectMilestoneActivities = projectMilestoneActivities;
	}
	...
	/**
	 * @return the projectMilestoneActivities
	 */
	public List<ProjectActivity> getProjectMilestoneActivities() {
		return projectMilestoneActivities;
	}

	/**
	 * @param projectMilestoneActivities the projectMilestoneActivities to set
	 */
	public void setProjectMilestoneActivities(List<ProjectActivity> projectMilestoneActivities) {
		this.projectMilestoneActivities = projectMilestoneActivities;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((projectMilestoneActivities == null) ? 0 : projectMilestoneActivities.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (projectMileStoneOwnerId != other.projectMileStoneOwnerId)
			return false;
		if (projectMilestoneActivities == null) {
			if (other.projectMilestoneActivities != null)
				return false;
		} else if (!projectMilestoneActivities.equals(other.projectMilestoneActivities))
			return false;
	...
	public String toString() {
		return "ProjectMilestone [projectMilestoneId=" + projectMilestoneId + ", projectMilestoneCompletion="
				...
				+ ", projectMilestoneCostCompliance=" + projectMilestoneCostCompliance + ", projectMilestoneActivities="
				+ projectMilestoneActivities + "]";
	}
}
