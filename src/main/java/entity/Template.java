...
public class Template implements Serializable {
	...
	@NotNull
	private List<Integer> templateRuleIds;
	...
	@NotNull
	List<entity.Field> fields = new ArrayList<entity.Field>();
	
	
	@NotNull
	List<entity.Category> categories = new ArrayList<entity.Category>();
	
	
	@NotNull
	List<entity.Data> data = new ArrayList<entity.Data>();
	 ...
	 * @param data
	 */
	public Template(@NotNull int templateId, @NotNull String templateParentId, @NotNull List<Integer> templateRuleIds,
			@NotNull String templateName, @NotNull int templateSequence, @NotNull String templateIndustryName,
			@NotNull String templateSectorName, @NotNull String templateStatus, @NotNull String templateVersion,
			@NotNull String templateCreatedBy, @NotNull String templateCreatedAt, @NotNull String templateUpdatedBy,
			@NotNull String templateUpdatedAt, @NotNull List<entity.Field> fields,
			@NotNull List<Category> categories, @NotNull List<Data> data) {
		super();
	...
	/**
	 * @return the templateRuleIds
	 */
	public List<Integer> getTemplateRuleIds() {
		return templateRuleIds;
	}

	/**
	 * @param templateRuleIds the templateRuleIds to set
	 */
	public void setTemplateRuleIds(List<Integer> templateRuleIds) {
		this.templateRuleIds = templateRuleIds;
	}
	 ...
	 * @return the fields
	 */
	public List<entity.Field> getFields() {
		return fields;
	}
	 ...
	 */
	public void setFields(List<entity.Field> fields) {
		this.fields = fields;
	}
	 ...
	 */
	public void setCategories(List<entity.Category> categories) {
		this.categories = categories;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((templateRuleIds == null) ? 0 : templateRuleIds.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (templateParentId == null) {
			...
			return false;
		if (templateRuleIds == null) {
			if (other.templateRuleIds != null)
				return false;
		} else if (!templateRuleIds.equals(other.templateRuleIds))
			return false;
	...
	public String toString() {
		return "Template [templateId=" + templateId + ", templateParentId=" + templateParentId + ", templateRuleIds="
				+ templateRuleIds + ", templateName=" + templateName + ", templateSequence=" + templateSequence
				+ ", templateIndustryName=" + templateIndustryName + ", templateSectorName=" + templateSectorName
				+ ", templateStatus=" + templateStatus + ", templateVersion=" + templateVersion + ", templateCreatedBy="
				+ templateCreatedBy + ", templateCreatedAt=" + templateCreatedAt + ", templateUpdatedBy="
				+ templateUpdatedBy + ", templateUpdatedAt=" + templateUpdatedAt + ", fields=" + fields
