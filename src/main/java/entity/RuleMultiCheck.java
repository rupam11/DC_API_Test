...
public class RuleMultiCheck implements Serializable{
	 ...
	 */
	public RuleMultiCheck(int ruleMultiCheckId, List<RuleData> ruleData, String ruleMultiCheckJoinOperator, String ruleDataFunctionType) {
		super();
	...
	public String toString() {
		return "RuleMultiCheck [ruleMultiCheckId=" + ruleMultiCheckId + ", ruleData=" + ruleData
				+ ", ruleMultiCheckJoinOperator=" + ruleMultiCheckJoinOperator + ",ruleDataFunctionType="+ruleDataFunctionType+"]";
	}
}