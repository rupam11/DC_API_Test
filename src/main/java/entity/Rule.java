...
private static final long serialVersionUID = 1L;
	...
	public int hashCode() {
		...
		result = prime * result + ((ruleExecutionType == null) ? 0 : ruleExecutionType.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (ruleExecutionType == null) {
			if (other.ruleExecutionType != null)
				return false;
		} else if (!ruleExecutionType.equals(other.ruleExecutionType))
			return false;
	...
	public String toString() {
		return "Rule [ruleId=" + ruleId + ", ruleParentId=" + ruleParentId + ", ruleNumber=" + ruleNumber
				...
				+ ", ruleConditionCheck=" + ruleConditionCheck + ", ruleExecutionType=" + ruleExecutionType + "]";
	}
