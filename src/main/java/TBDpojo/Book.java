...
public class Book implements Serializable {
	 ...
	 * @param users
	 */
	public Book(@NotNull int bookId, @NotNull String bookParentId, @NotNull String bookName, @NotNull String bookType,
			@NotNull String bookIndustryName, @NotNull String bookSectorName, @NotNull String bookStatus,
			@NotNull String bookVersion, @NotNull String bookCreatedBy, @NotNull String bookCreatedAt,
			@NotNull String bookUpdatedBy, @NotNull String bookUpdatedAt, @NotNull List<Template> templates,
			@NotNull List<BookUser> users) {
		super();
		this.bookId = bookId;
	...
	public String toString() {
		return "Book [bookId=" + bookId + ", bookParentId=" + bookParentId + ", bookName=" + bookName + ", bookType="
				+ bookType + ", bookIndustryName=" + bookIndustryName + ", bookSectorName=" + bookSectorName
				+ ", bookStatus=" + bookStatus + ", bookVersion=" + bookVersion + ", bookCreatedBy=" + bookCreatedBy
				+ ", bookCreatedAt=" + bookCreatedAt + ", bookUpdatedBy=" + bookUpdatedBy + ", bookUpdatedAt="
				+ bookUpdatedAt + ", templates=" + templates + ", users=" + users + "]";
	}
}