...
public class Project implements Serializable {
	...
	public Project(@NotNull int projectId, @NotNull String projectParentId, @NotNull String projectName,
			@NotNull String projectStatus, @NotNull String projectPasscode, @NotNull String projectPurpose,
			@NotNull String projectType, @NotNull List<Integer> bookIds, @NotNull String projectDescription,
			@NotNull ProjectInsight projectInsight, @NotNull List<ProjectMilestone> projectMilestone,
			@NotNull List<ProjectUser> users, @NotNull String projectSector, @NotNull String projectIndustry,
			@NotNull String projectCreatedBy, @NotNull String projectCreatedAt, @NotNull String projectUpdatedBy,
			@NotNull String projectUpdatedAt) {
		super();
	...
	public String toString() {
		return "Project [projectId=" + projectId + ", projectParentId=" + projectParentId + ", projectName="
				+ projectName + ", projectStatus=" + projectStatus + ", projectPasscode=" + projectPasscode
				+ ", projectPurpose=" + projectPurpose + ", projectType=" + projectType + ", bookIds=" + bookIds
				+ ", projectDescription=" + projectDescription + ", projectInsight=" + projectInsight
				+ ", projectMilestone=" + projectMilestone + ", users=" + users + ", projectSector=" + projectSector
				+ ", projectIndustry=" + projectIndustry + ", projectCreatedBy=" + projectCreatedBy
				+ ", projectCreatedAt=" + projectCreatedAt + ", projectUpdatedBy=" + projectUpdatedBy
