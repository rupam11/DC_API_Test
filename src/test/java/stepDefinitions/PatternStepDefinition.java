...
public class PatternStepDefinition extends Utils {
	...
	public void user_Pattern_Payload(String userRole, String payloadReq, String param) throws IOException {
		...
		if (payloadReq.equalsIgnoreCase("Add")) {
			...
			reqSpec = null;
			reqSpec = given().spec(requestSpecification(userRole)).body(reqPattern).queryParam(param,
					respPattern.getPatternId());
	...
	public void user_Pattern_Payload_with_invalid_Param(String userRole, String payloadReq, String param, int i)
			throws IOException {
	...
	public void user_invoke_getPatternBySearchCriteria_with_Parameter(String userRole, String param)
			throws IOException {
	...
	public void user_invoke_getPatternBySearchCriteria_with_all_Parameter(String userRole, String param1, String param2,
			String param3, String param4) throws IOException {
		reqSpec = null;
		reqSpec = given().spec(requestSpecification(userRole)).queryParams(param1, respPattern.getPatternId())
				.queryParam(param2, respPattern.getPatternName()).queryParam(param3, respPattern.getPatternState())
	...
	public void verify_Patternfields_gets_updated() {
		...
		JSONAssert.assertEquals(new JSONObject(reqPattern).toString(), new JSONObject(respPattern).toString(),
				new CustomComparator(JSONCompareMode.LENIENT, new Customization("patternUpdatedAt", (o1, o2) -> true),
...
//						new Customization("taskUpdatedBy", (o1, o2) -> true)));
	...
	public void each_Pattern_of_returned_PatternList_should_have_same_pattern(String searchItem) {
		assertTrue("All searched List do not satisfy search criteria",
				verify_all_records_with_search_criteria(searchItem));
	}
	...
	public void user_Pattern_Payload_with_no_Pattern_Body(String userRole, String payloadReq, String param)
			throws IOException {
		reqSpec = null;
