...
public class SectorStepDefinition extends Utils {
	...
	public void user_sector_Payload_with_no_Sector_Body_and_Param(String userRole, String payloadReq, String param)
			throws IOException {
		reqSpec = null;
	 ...
	 * ) public void user_Sector_Payload_with_invalid_Param_and_value(String
	 * userRole, String param, String payloadReq, int i) throws IOException {
	 * reqSector = data.updateSector(respSector); reqSpec=null; reqSpec =
	 * given().spec(requestSpecification(userRole)).body(reqSector).queryParam(param
	 * ,i); }
	 */
