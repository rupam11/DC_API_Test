...
public class FieldStepDefinition extends Utils {
	...
	/*
	 * @Then("Compare requestBody and ResponseBody") public void
	 * compare_reqBody_respBody() { JSONAssert.assertEquals(reqField, respField, new
	 * CustomComparator(JSONCompareMode.LENIENT, new Customization("timestamp", (o1,
	 * o2) -> true)));
	 * 
	 * }
	 */
