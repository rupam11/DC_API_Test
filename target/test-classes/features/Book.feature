...
Feature: Validating Book-Service APIs

	@addCategoryToTemplatesToBook
	@addFieldToTemplatesToBook
	@addTemplateToBook
	@addUsersToBook
	@changeCategorySequence
	@changeFieldSequence
	@changeIds
	...
	@cloneBookList
	@configureBook
	@copyCategoryToTemplateToBook
	@copyFieldsToTemplateToBook
	@copyRulesToBooks
	@copyTemplateToBook
	@createBook
	@createDummyBook
	@createDummyField
	@createEstimationBook
	@createProjectBook
	@deleteBook
	@deleteCategoryFromTemplatesToBook
	@deleteFieldFromTemplatesToBook
	@deleteTemplateFromBook
	@downloadStaffingPlan
	@getAllBooks
	@getAllBooksOfProject
	@getBookById
	@getBookBySearchCriteria
	@getBookCount
	@getStaffingPlan
	@getTranformationAdvisoryReport
	@getVersionForEstimation
	@importProjectBook
	@manageCategoriesToTemplateToBook
	@manageTemplates
	@registerBook
	@updateBook
	@updateCategoryToTemplatesToBook
	@updateFieldToTemplatesToBook
	@updateTemplateToBook
